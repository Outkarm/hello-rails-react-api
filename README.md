...
Click [Here](https://github.com/Outkarm/hello-rails-react-ui/pull/2)to take you to the frontend pull request.
...
```sh
git clone git@github.com:Outkarm/hello-rails-react-api.git
...
Feel free to check the [issues page](https://github.com/Outkarm/hello-rails-react-api/issues) for any open issues or to create a new one.
